        ...
        const getReserve = async () => {
            ...
            try {
                ...
                if (response.data.reserve) {
                    ...
                    if (response.data.reserve.participating._id !== userResponse.data.user._id) {
                ...
                if (error.response?.status === 401) {
                    ...
                    setErrorMessage("Error al cargar la reserva. Por favor, inténtalo de nuevo.");
                    setTimeout(() => {
                        navigate('/reserves');
                    }, 2000);
                }
    ...
    return (
        <div className=" reserve">
            ...
            <div className="container centerReserve">
                <div className="reserveTitle text-center mt-3"><p>GESTION DE RESERVA</p></div>
                <div className="container tablaReserve table table-responsive">
                    <div className="headReserve">
                        <div><strong>Evento</strong> {event ? event.name : <span className="text-danger">El evento ya no existe</span>}</div>
